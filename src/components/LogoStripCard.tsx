...
const LogoStripCard = () => (
  <section className="px-6 py-10 md:py-14">
    <div className="mx-auto max-w-3xl rounded-2xl bg-card shadow-[0_4px_24px_-4px_hsl(var(--foreground)/0.06)] px-8 py-8">
      <FadeIn>
        <p className="mb-6 text-center font-sans text-xs tracking-[0.15em] uppercase text-muted-foreground/70">
